...
__all__ = [
    ...
    "SaveButtonRosWrapperException"
]


class SaveButtonRosWrapperException(Exception):
    pass


class SaveButtonRosWrapper:
    def __init__(self, hardware_version='ned2'):
        ...
        self.__save_button_state = EEButtonStatus.NO_ACTION

        self.__save_button_topic = rospy.Subscriber(
    ...
    def __check_ned_2_version(self):
        if self.__hardware_version != 'ned2':
            raise SaveButtonRosWrapperException(
    ...
    def state(self):
        ...
        return self.__save_button_state
    ...
    def is_pressed(self):
        ...
        """
        self.__check_ned_2_version()
        return self.__save_button_state != EEButtonStatus.NO_ACTION
    ...
    def __set(self, action):
        self.__save_button_state = action
    ...
    def __callback_save_pos_button_status(self, save_button_status):
        self.__set(save_button_status.action)
        self.callback(save_button_status)
