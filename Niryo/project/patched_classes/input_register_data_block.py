...
IR_HARDWARE_TEMPERATURE = 410
IR_HARDWARE_VOLTAGES = 418
IR_HARDWARE_ERRORS = 426
...
class InputRegisterDataBlock(DataBlock):
    ...
    def __init__(self):
        ...
        self.collision_detected_sub = None
    ...
    def start_ros_subscribers(self):
        ...
        self.collision_detected_sub = rospy.Subscriber('/niryo_robot/collision_detected', 
                                                       Bool, 
                                                       self.sub_collision_detected)
    ...
    def stop_ros_subscribers(self):
        ...
        self.collision_detected_sub.unregister()

    def sub_joint_states(self, msg):
        self.setValuesOffset(IR_JOINTS, [handle_negative(int(joint * MULT)) for joint in msg.position])
    ...
    def sub_selected_tool_id(self, msg):
        self.setValuesOffset(IR_SELECTED_TOOL_ID, int(msg.data))

    def sub_learning_mode(self, msg):
        self.setValuesOffset(IR_LEARNING_MODE, int(msg.data))
    ...
    def sub_hardware_status(self, msg):
        ...
        self.setValuesOffset(IR_HARDWARE_TEMPERATURE, [int(i) for i in msg.temperatures])
        self.setValuesOffset(IR_HARDWARE_VOLTAGES, [int(i*MULT) for i in msg.voltages])
        self.setValuesOffset(IR_HARDWARE_ERRORS, [int(i) for i in msg.hardware_errors])
    ...
    def sub_collision_detected(self, msg):
        self.setValuesOffset(IR_COLLISON_DETECTED, int(msg.data))